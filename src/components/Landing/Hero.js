      ...
      <div class="container mx-auto flex flex-col px-5 py-20 justify-center items-center">
        ...
        <div class="w-full md:w-2/3 flex flex-col items-center text-center">
          ...
          <p class="mb-8 leading-relaxed">
            We are the most reliable part of your holiday
          </p>
          <div class="flex w-full justify-center items-end">
            ...
            <button onClick={()=> Navigate("signup")} class="inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">
              Search
            </button>
          </div>
          <p class="text-sm mt-2 text-gray-500 mb-8 w-full">
            Select the nearest possible centre
          </p>
